...
public class ModFeatures {
    ...
    public static final RegistryObject<Feature<NoneFeatureConfiguration>> MANA_CASTLE = FEATURES.register("mana_castle",
            () -> new ManaCastleFeature(NoneFeatureConfiguration.CODEC));

    public static final RegistryObject<Feature<NoneFeatureConfiguration>> MANA_CASTLE_DEBUG = FEATURES.register(
            "mana_castle_debug",
            () -> new ManaCastleDebugFeature(NoneFeatureConfiguration.CODEC));

    public static final RegistryObject<Feature<NoneFeatureConfiguration>> SECRET_SHOP = FEATURES.register("secret_shop",
            () -> new SecretShopFeature(NoneFeatureConfiguration.CODEC));

    public static final RegistryObject<Feature<NoneFeatureConfiguration>> SECRET_SHOP_DEBUG = FEATURES.register(
            "secret_shop_debug",

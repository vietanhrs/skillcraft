...
public class ModEntityTypes {
    ...
    public static final DeferredRegister<EntityType<?>> ENTITY_TYPES =
            DeferredRegister.create(ForgeRegistries.ENTITY_TYPES, Skillcraft.MOD_ID);

    public static final RegistryObject<EntityType<SecretMerchant>> SECRET_MERCHANT =
            ENTITY_TYPES.register("secret_merchant", () ->

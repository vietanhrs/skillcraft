...
/**
 * Generates a Secret Shop tent near the world origin whenever
 * {@code debugSpawnNearby = true} in the config.
 */
public class SecretShopDebugFeature extends SecretShopFeature {

    private static final int SPAWN_CHUNK_RADIUS = 2;

    public SecretShopDebugFeature(Codec<NoneFeatureConfiguration> codec) {
        super(codec);
    }

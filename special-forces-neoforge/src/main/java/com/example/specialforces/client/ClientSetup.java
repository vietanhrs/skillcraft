...
public class ClientSetup {
    ...
    public static void registerOverlays(RegisterGuiLayersEvent event) {
        event.replaceLayer(VanillaGuiLayers.CROSSHAIR, (graphics, deltaTracker) -> {});
    ...
    public static void init() {
        NeoForge.EVENT_BUS.addListener(ClientSetup::onComputeFov);
        NeoForge.EVENT_BUS.addListener(ClientSetup::onComputeCameraAngles);
        NeoForge.EVENT_BUS.addListener(ClientSetup::onClientTick);
        NeoForge.EVENT_BUS.addListener(ClientSetup::onInteractionKey);
        NeoForge.EVENT_BUS.addListener(ClientSetup::onRenderHand);
    }
